...
import com.clinic.vaxschedular.Services.JWTService;
import com.clinic.vaxschedular.Services.UserService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    // bigp el info el mmaogoda fe el header lkol request
